...
[Pip.Services Configuration Help](https://github.com/pip-services/pip-services/blob/master/usage/Configuration.md)
...
Example:
```yaml
- descriptor: "service-help:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
